from src.values.colors import BLACK
from src.values.config import FILE_NAME_RECORD, RECORD, SCORE, LINE
from src.values.numbers import ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, ZERO
