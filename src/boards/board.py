import pygame
from src.values.config import GREEN, LIGHT_BLUE, DARK_BLUE, RED, YELLOW, PURPLE, ORANGE, ONE_LINE_SCORE
from src.values.colors import GREY
from src.boards.media_and_image import Image
from src.values.config import BOARD
